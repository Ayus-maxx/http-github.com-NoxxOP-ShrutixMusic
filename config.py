...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Ayus-maxx/http-github.com-NoxxOP-ShrutixMusic",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/7uzuum.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/t6p8mp.jpg"
)
